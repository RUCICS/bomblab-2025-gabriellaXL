...
0000000000001435 <phase_1>:
    1435:	48 83 ec 08          	sub    $0x8,%rsp # 将栈顶指针（%rsp）向下移动8个字节，即在栈顶分配8个字节的空间，在程序中为局部变量或者函数参数分配空间
    ...
    1447:	75 05                	jne    144e <phase_1+0x19>  # 如果两个字符串不相等则跳到144e    
    1449:	48 83 c4 08          	add    $0x8,%rsp # 释放栈上空间
    144d:	c3                   	ret
    144e:	e8 98 0a 00 00       	call   1eeb <explode_bomb> # 字符串不相等跳到这里后引爆炸弹
...
0000000000001544 <phase_3>:
    ...
    1599:	ff e0                	jmp    *%rax
    159b:	b8 c0 03 00 00       	mov    $0x3c0,%eax
    15a0:	2d 50 02 00 00       	sub    $0x250,%eax
    15a5:	05 ac 02 00 00       	add    $0x2ac,%eax
    15aa:	8d 98 58 fd ff ff    	lea    -0x2a8(%rax),%ebx
    15b0:	e8 36 09 00 00       	call   1eeb <explode_bomb>
    15b5:	8d 83 a8 02 00 00    	lea    0x2a8(%rbx),%eax
    15bb:	2d a8 02 00 00       	sub    $0x2a8,%eax
    15c0:	05 a8 02 00 00       	add    $0x2a8,%eax
    15c5:	2d a8 02 00 00       	sub    $0x2a8,%eax
...
00000000000016f2 <phase_4>:
    ...
    1759:	be 1a 00 00 00       	mov    $0x1a,%esi
